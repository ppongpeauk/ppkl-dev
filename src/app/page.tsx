    ...
    <main className="flex flex-col px-4 lg:px-0 lg:flex-row items-center justify-center pt-16 gap-16">
      <div className="lg:max-w-[480px] order-1 lg:order-2">
        ...
        <p className="mt-0">
          ...
          efficient systems, actively in search of opportunities that will allow
          me to help make the world a better place.
        </p>
        <p>
          Right now, I&apos;m working on <strong>Unitrade</strong>, a platform
          that let&apos;s college students buy and sell goods and services with
        ...
        <section className="flex gap-2">
          ...
          <a href="https://linkedin.com/in/pete-pongpeauk" target="_blank">
            LinkedIn
          </a>
